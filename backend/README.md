...
### Team Task Manager — Built for the Ethara.ai Internship Assignment
...
**[🌐 Live Demo](https://taskflow-frontend-production-6a65.up.railway.app)** · **[🎥 Demo Video](#)** · **[📦 Backend API](https://your-backend.railway.app/api/health)**
...
Built by **Arnav Ashta** · Submitted for the Ethara.ai Full Stack Developer Internship
